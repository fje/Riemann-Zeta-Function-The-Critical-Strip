...
\end{corollary}
\begin{proof}
	This estimate combining the growth of $\zeta'$ shown in Proposition and the estimate for $\frac{1}{\zeta}$ of Proposition we immediately receive our desired estimate.
\end{proof}