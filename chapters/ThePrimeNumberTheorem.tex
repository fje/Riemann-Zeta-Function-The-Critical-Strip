The prime number theorem is a very fundamental statement about the asymptotic behaviour of the distribution of prime numbers and may be stated as follows:
...
\begin{tikzpicture}
	[decoration={
		markings,
		mark=at position 0.8cm with {\arrow[line width=1pt]{>}},
		mark=at position 7cm with {\arrow[line width=1pt]{>}}
	}]

	% The path
	\path[draw,line width=0.6pt,postaction=decorate] (-3, -3) -- (-3, 3);
	\path[draw,line width=0.6pt,postaction=decorate] (-0.5, -3) -- (-0.5, -1) -- (0.5, -1) -- (0.5, 1) -- (-0.5, 1) -- (-0.5, 3);
	\path[draw,line width=0.6pt,postaction=decorate] (3.5, -3) -- (3.5, -1) -- (2.8, -1) -- (2.8, 1) -- (3.5, 1) -- (3.5, 3);
	
	% The labels
	\node[below] at (-3.8, 0) {$s = 1$};
	\node[below] at (-0.5, 0) {$s = 1$};
	\node[below] at (3.5, 0) {$s = 1$};
	
	\node[below] at (-3, -3.62) {$\sigma = c$};
	\node[below] at (-0.5, -3.5) {$\gamma(T)$};
	\node[below] at (3.5, -3.5) {$\gamma(T, \delta)$};
	
	\node[right] at (3.5, -2) {$\gamma_1$};
	\node[below] at (3.1, -1) {$\gamma_2$};
	\node[left] at (2.8, -0.6) {$\gamma_3$};
	\node[above] at (3.1, 1) {$\gamma_4$};
	\node[right] at (3.5, 2) {$\gamma_5$};
	
	\node[above] at (0.5, 1) {$c + iT$};
	\node[left] at (2.8, 0) {$1 - \delta$};
	
	\draw[xshift=0cm] (-3.8,0) node[circle,fill,inner sep=1.2pt](a){};	
	\draw[xshift=0cm] (-0.5,0) node[circle,fill,inner sep=1.2pt](a){};
	\draw[xshift=0cm] (3.5,0) node[circle,fill,inner sep=1.2pt](a){};
	\draw[xshift=0cm] (0.5, 1) node[circle,fill,inner sep=1.2pt](a){};
	\draw[xshift=0cm] (2.8, 0) node[circle,fill,inner sep=1.2pt](a){};
\end{tikzpicture}
